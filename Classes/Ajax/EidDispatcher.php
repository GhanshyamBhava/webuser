 ...
 * 
 * - $TYPO3_CONF_VARS['BE']['eID_include']['webuserWebuser'] = \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::extPath('webuser').'Classes/Ajax/EidDispatcher.php';
 * - $TYPO3_CONF_VARS['FE']['eID_include']['webuserWebuser'] = \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::extPath('webuser').'Classes/Ajax/EidDispatcher.php';
 *
 ...
 *			   eID: "ajaxDispatcher",  
 *			   request: {
 *			       pluginName:  'tx_webuser_fewebuser',
 *			       controller:  'Users',
 *			       action:      'delete',
 *			       arguments: {
 *			           'user': fieldObj,
